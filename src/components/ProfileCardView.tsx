    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center justify-between">
        ...
        <motion.button
          ...
          className="flex items-center gap-1.5 bg-emerald-500 text-neutral-950 hover:bg-emerald-400 text-xs font-black px-4 py-2 rounded-xl transition cursor-pointer uppercase tracking-wider shadow shadow-emerald-500/10"
        >
      ...
      <motion.div 
        ...
        className="relative overflow-hidden glass emerald-glow p-6 sm:p-8 shadow-2xl rounded-2xl flex flex-col items-center justify-center transition-all duration-300 border-white/10"
      >
        {/* Glow Effects */}
          ...
          <div className="space-y-2">
            {activeSkills.map((skill, index) => (
              <motion.div 
                ...
                className="flex items-center justify-between bg-white/[0.03] border border-white/5 px-3 py-2.5 rounded-xl text-xs font-bold transition-colors"
              >
      ...
      <motion.div variants={itemVariants} className="p-4 bg-white/5 rounded-xl border border-white/10 flex items-start gap-3">
